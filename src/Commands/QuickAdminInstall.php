...
namespace Dasteem\Laragenerators\Commands;

use App\User;
use Illuminate\Console\Command;
use Dasteem\Laragenerators\Models\Crud;
use Dasteem\Laragenerators\Models\Role;

class LaraGeneratorsInstall extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'laragenerators:install';
     ...
     * @var string
     */
    protected $description = 'Run installation of LaraGenerators.';
    ...
    {
        $this->info('Starting installation process of LaraGenerators...');
