<?php
namespace Dasteem\Laragenerators\Builders;
...
class ModelBuilder
{
    ...
    */
    ...
    public function set' . $camel . 'Attribute($input)
    {
        $this->attributes[\'' . $field->title . '\'] = Carbon::createFromFormat(config(\'laragenerators.date_format\'), $input)->format(\'Y-m-d\');
    }
    ...
    {
        return Carbon::createFromFormat(\'Y-m-d\', $input)->format(config(\'laragenerators.date_format\'));
    }' . "\r\n\r\n";
            }
        }
